      ...
      <div className="flex">
        <div className="bg-gray-800 w-64 h-screen p-4">
          ...
          <ul className="space-y-2">
            <li className="p-2 bg-blue-700 rounded">Home</li>
            <li className="p-2 rounded hover:bg-gray-700">Friends</li>
            <li className="p-2 rounded hover:bg-gray-700">Settings</li>
            <li onClick={handleLogout} className="p-2 rounded hover:bg-gray-700 cursor-pointer">
              Logout
            </li>
          </ul>
        </div>
